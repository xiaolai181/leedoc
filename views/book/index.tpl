...
<div class="manual-reader">
    ...
    <div class="container manual-body">
        <div class="row">
            <div class="page-left">
                <ul class="menu">
                    <li {{if eq .ControllerName "BookController"}}class="active"{{end}}><a href="/book" class="item"><i class="fa fa-sitemap" aria-hidden="true"></i> {{i18n $.Lang "common.my_project"}}</a> </li>
                    <li {{if eq .ControllerName "BlogController"}}class="active"{{end}}><a href="/manage/blogs" class="item"><i class="fa fa-file" aria-hidden="true"></i> {{i18n $.Lang "common.my_blog"}}</a> </li>
                </ul>
            </div>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a :href="'{{ .BaseUrl }}docs' + item.identify" target="_blank">{{i18n $.Lang "blog.read"}}</a></li>
                                    ...
                                    {{/*<a :href="''{{ .BaseUrl }}docs'' + item.identify" title="{{i18n $.Lang "blog.view"}}" data-toggle="tooltip" target="_blank"><i class="fa fa-eye"></i> {{i18n $.Lang "blog.view"}}</a>*/}}
                                    {{/*<template v-if="item.role_id != 3">*/}}
...
<div class="modal fade" id="addBookDialogModal" tabindex="-1" role="dialog" aria-labelledby="addBookDialogModalLabel">
    <div class="modal-dialog modal-lg" role="document" style="min-width: 900px;">
        <form method="post" autocomplete="off" action="{{ .BaseUrl }}book/create" id="addBookDialogForm" enctype="multipart/form-data">
...
<div class="modal fade" id="importBookDialogModal" tabindex="-1" role="dialog" aria-labelledby="importBookDialogModalLabel">
    <div class="modal-dialog" role="document" style="min-width: 900px;">
        <form method="post" autocomplete="off" action="{{ .BaseUrl }}book/users/import" id="importBookDialogForm" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="deleteBookModal" tabindex="-1" role="dialog" aria-labelledby="deleteBookModalLabel">
    <div class="modal-dialog" role="document">
        <form method="post" id="deleteBookForm" action="{{ .BaseUrl }}book/setting/delete">
    ...
    $(function () {
        ...
        $("#addBookDialogModal").on("show.bs.modal",function () {
            ...
            $('.js-data-example-ajax-add').select2({
                ...
                width : "100%",
                ajax: {
                    url: '{{ .BaseUrl }}book/itemsets/search',
                    dataType: 'json',
        ...
        $("#importBookDialogModal").on("show.bs.modal",function () {
            ...
            $("#import-book-upload").fileinput({
                'uploadUrl':"{{ .BaseUrl }}book/users/import",
                'theme': 'fa',
                'showPreview': false,
                'showUpload' : false,
                'required': true,
